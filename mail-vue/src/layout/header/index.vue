  ...
  <div class="header" :class="!hasPerm('email:send') ? 'not-send' : ''">
    ...
    <div class="toolbar">
      <el-dropdown @command="handleThemeChange" trigger="click">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item command="light" :class="{ 'active-item': uiStore.themeMode === 'light' }">
              <Icon icon="mingcute:sun-fill" style="margin-right: 8px;" />
              {{ $t('themeLight') }}
            </el-dropdown-item>
            <el-dropdown-item command="dark" :class="{ 'active-item': uiStore.themeMode === 'dark' }">
              <Icon icon="solar:moon-linear" style="margin-right: 8px;" />
              {{ $t('themeDark') }}
            </el-dropdown-item>
            <el-dropdown-item command="system" :class="{ 'active-item': uiStore.themeMode === 'system' }">
              <Icon icon="solar:monitor-linear" style="margin-right: 8px;" />
              {{ $t('themeSystem') }}
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
...
const themeIcon = computed(() => {
    if (uiStore.themeMode === 'light') return 'solar:moon-linear'
    if (uiStore.themeMode === 'dark') return 'mingcute:sun-fill'
